                        ...
                        <v-row>
                            <v-col cols="12" lg="5">
                                <div class="zo-about">
                                    ...
                                    <p>
                                        خانه انقلاب اسلامی با هدف تبیین روشمند منظومه فکری حضرت آیت‌الله‌العظمی خامنه‌ای، بستری تخصصی برای رشد معرفتی دانشجویان و فعالان فرهنگی فراهم آورده است. این مجموعه با برگزاری دوره‌های آموزشی معارف‌محور و کادرسازی برای جبهه فرهنگی انقلاب، در مسیر اعتلای بینش نخبگان گام برمی‌دارد. همچنین تأمین و عرضه آثار و کتب رهبر معظم انقلاب جهت دسترسی آسان پژوهشگران، بخشی از رسالت ما در جهت تعمیق معرفت دینی و انقلابی است. ما متعهد به پیوند اندیشه با عمل در تراز تمدن نوین اسلامی هستیم.
