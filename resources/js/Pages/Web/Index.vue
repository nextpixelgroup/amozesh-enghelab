                        ...
                        <v-row>
                            <v-col cols="12">
                                <div class="zo-title">
                                    ...
                                    <span>گزیده دوره‌های پرمخاطب و مورد استقبال دانش‌پژوهان</span>
                                </div>
                            </v-col>
                        </v-row>
                        ...
                        <v-row>
                            <v-col cols="12">
                                <div class="zo-title">
                                    ...
                                    <span>جدیدترین عناوین آموزشی و محتواهای تخصصی منتشر شده</span>
                                </div>
                            </v-col>
                        </v-row>
                        <v-row class="align-center">
                    ...
                    <v-row class="align-center">
                        <v-col lg="6" cols="12">
                            <div class="zo-content">
                                ...
                                <p>
                                    این سامانه با هدف تبیین نظام‌مند منظومه فکری حضرت آیت‌الله‌العظمی خامنه‌ای، مجموعه‌ای از دوره‌های محتوایی را بر پایه کتب و بیانات رهبر معظم انقلاب ارائه می‌دهد. ارقام ثبت‌شدۀ این بخش، بازتابی از کیفیت سرفصل‌ها و استقبال دانشجویان و فعالان فرهنگی از مسیر کادرسازی جبهه انقلاب است.
                                </p>
                            </div>
                        </v-col>
                        <v-col lg="6" cols="12">
...
@media (max-width: 990px) {
    ...
    .zo-home-section .zo-slider-section .zo-swiper :deep(.swiper-slide) img {
        height: auto !important; /* ارتفاع بر اساس عرض تنظیم می‌شود */
        width: 100%;
        object-fit: contain; /* کل عکس نمایش داده می‌شود */
        max-height: 100%;
    }

    /* اگر کانتینر اسلاید هم ارتفاع ثابت دارد، آن را هم آزاد کنید */
    .zo-home-section .zo-slider-section .zo-swiper :deep(.swiper-slide) {
        height: auto;
    }
}
